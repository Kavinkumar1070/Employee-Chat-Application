...
Revision ID: d31ed666d06a
Revises: 44926f2ef23b
Create Date: 2024-08-20 17:06:36.836181
...
revision: str = 'd31ed666d06a'
down_revision: Union[str, None] = '44926f2ef23b'
...
def downgrade() -> None:
    ...
    sa.Column('DateOfBirth', mysql.VARCHAR(length=250), nullable=False),
